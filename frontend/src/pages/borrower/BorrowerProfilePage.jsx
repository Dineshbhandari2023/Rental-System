...
const BorrowerProfilePage = () => {
  ...
  //             <div className="animate-spin rounded-full h-14 w-14 border-4 border-amber-700 border-t-transparent mx-auto"></div>
  //             <p className="mt-5 text-xl text-amber-900 font-medium">
