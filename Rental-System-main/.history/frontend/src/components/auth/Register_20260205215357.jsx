...
const Register = () => {
  ...
  const validateStep2 = () => {
    ...
    if (!formData.address.zipCode.trim()) {
      ...
      newErrors["address.zipCode"] = "Please enter a valid 5-digit ZIP code";
    }
        ...
        {[1, 2, 3].map((stepNumber) => (
          <React.Fragment key={stepNumber}>
            <motion.div
              ...
              className={`rounded-full relative flex items-center justify-center w-14 h-14 border-2 font-serif font-bold text-lg transition-all duration-300 ${
                step >= stepNumber
    ...
    <motion.div variants={itemVariants}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full ${
            Icon ? "pl-12" : "pl-4"
          } pr-4 py-3 bg-gray-800/50 border-2 font-serif text-amber-100 placeholder-amber-700/50 focus:outline-none focus:border-amber-600 focus:bg-gray-800 transition-all duration-300 ${
  ...
  const renderStep2 = () => (
    ...
    >
      ...
      <motion.div
        variants={itemVariants}
        className="bg-gradient-to-r from-blue-900/20 to-blue-800/20 border-2 border-blue-700/30 p-4 rounded-md"
      >
  ...
  const renderStep3 = () => (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <motion.div
          variants={itemVariants}
          className="bg-gradient-to-br from-amber-900/20 to-amber-800/10 border-2 border-amber-800/30 p-6 h-fit rounded-md"
        >
      ...
      <motion.div variants={itemVariants}>
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={handleChange}
            className={`w-full pl-12 pr-12 py-3 bg-gray-800/50 border-2 font-serif text-amber-100 placeholder-amber-700/50 focus:outline-none focus:border-amber-600 focus:bg-gray-800 transition-all duration-300 rounded-md ${
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-3xl w-full space-y-8 relative z-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className="relative bg-gradient-to-br from-gray-800 to-gray-900 border-2 border-amber-900/30 shadow-2xl p-8 md:p-10 rounded-xl"
        >
          {/* Decorative corners */}
