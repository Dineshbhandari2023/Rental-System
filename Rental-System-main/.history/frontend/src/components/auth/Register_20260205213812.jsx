...
const Register = () => {
  ...
  // Animation variants (slightly refined timing)
  const containerVariants = {
    hidden: { opacity: 0 },
  ...
  const StepIndicator = () => (
    <div className="mb-10">
      <div className="flex items-center justify-center">
        {[1, 2, 3].map((num) => (
          <React.Fragment key={num}>
            <div
              className={`relative flex h-12 w-12 items-center justify-center rounded-full border-2 text-lg font-semibold transition-all duration-300 ${
                step >= num
                  ? "border-amber-600 bg-amber-700/90 text-white shadow-md shadow-amber-900/40"
            ...
            {num < 3 && (
              <div
                className={`h-0.5 w-16 transition-all duration-500 ${
                  step > num ? "bg-amber-600" : "bg-slate-700"
                }`}
              />
            )}
          </React.Fragment>
      ...
      <div className="mt-4 flex justify-between text-sm font-medium text-slate-400">
        {["Personal", "Address", "Account"].map((label, i) => (
          <span key={label} className={step >= i + 1 ? "text-amber-400" : ""}>
            {label}
          </span>
        ))}
      </div>
    ...
    <div className="space-y-1.5">
      ...
      <div className="relative">
        ...
        <input
          ...
          name={name}
          type={type}
          className={`block w-full rounded-lg border bg-slate-900/60 px-4 py-3 text-slate-100 placeholder-slate-500 transition-all focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 focus:outline-none ${
            Icon ? "pl-11" : "pl-4"
          } ${
            error
  ...
  // ────────────────────────────────────────────────
  //    STEP RENDERERS (mostly layout + className changes)
  // ────────────────────────────────────────────────
  ...
  const renderStep1 = () => (
    <motion.div variants={containerVariants} className="space-y-6">
      ...
      <InputField
        ...
        helpText="Used for account verification and notifications"
      />
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex items-center gap-4">
          <div className="h-20 w-20 overflow-hidden rounded-full border-2 border-slate-700 bg-slate-800">
            {profileImage ? (
              <img
          ...
          <label className="cursor-pointer rounded-lg border border-slate-600 bg-slate-800/50 px-5 py-2.5 text-sm font-medium text-slate-300 transition hover:border-amber-600/70 hover:text-amber-300">
            Choose file
            <input
              type="file"
              accept="image/*"
        ...
        <p className="text-xs text-slate-500">JPG, PNG • Max 2 MB</p>
      </div>
    </motion.div>
  );
  ...
  const renderStep2 = () => (
    <motion.div variants={containerVariants} className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            value={formData.address.state}
            onChange={handleChange}
            className={`w-full rounded-lg border bg-slate-900/60 px-4 py-3 text-slate-100 focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 focus:outline-none ${
              errors["address.state"] ? "border-red-600/70" : "border-slate-700"
            }`}
          >
            <option value="">Select province</option>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            value={formData.address.country}
            onChange={handleChange}
            className="w-full rounded-lg border border-slate-700 bg-slate-900/60 px-4 py-3 text-slate-100 focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 focus:outline-none"
          >
            <option value="NPL">Nepal</option>
            <option value="IND">India</option>
      ...
      <div className="rounded-lg border border-slate-700/70 bg-slate-800/30 p-5 text-sm text-slate-300">
        <div className="flex gap-3">
          <ShieldCheckIcon className="h-5 w-5 flex-shrink-0 text-amber-500/80" />
          <p>
            Your address helps enable location-based matching and delivery
            coordination. It is never shown publicly.
          </p>
        </div>
      </div>
    </motion.div>
          ...
          {[
            {
              value: "borrower",
              label: "Borrower",
              desc: "Rent items from others",
            },
            { value: "lender", label: "Lender", desc: "Share your items" },
            { value: "both", label: "Both", desc: "Rent & lend" },
          ].map((r) => (
            <label
              key={r.value}
              className={`flex cursor-pointer flex-col rounded-lg border p-5 transition-all ${
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="h-5 w-5 border-slate-600 text-amber-600 focus:ring-amber-500"
                />
              </div>
            </label>
          ))}
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              value={formData.password}
              onChange={handleChange}
              className={`w-full rounded-lg border bg-slate-900/60 pl-11 pr-11 py-3 text-slate-100 placeholder-slate-500 focus:border-amber-500 focus:ring-1 focus:ring-amber-500/30 focus:outline-none ${
                errors.password ? "border-red-600/70" : "border-slate-700"
              }`}
              placeholder="••••••••"
            />
            <button
      ...
      <div className="space-y-3 pt-2">
        <label className="flex items-start gap-3">
          <input
            type="checkbox"
            required
            className="mt-1 h-5 w-5 rounded border-slate-600 text-amber-600 focus:ring-amber-500"
          />
        ...
        <label className="flex items-start gap-3">
          ...
          />
          <span className="text-sm text-slate-300">
            Send me product updates and occasional offers
          </span>
        </label>
      </div>
    </motion.div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 py-12 px-5 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mt-3 text-lg text-slate-400">
            Join Nepal's trusted item-sharing community
          </p>
        </div>

        {/* Card */}
        <div className="overflow-hidden rounded-2xl border border-slate-800/80 bg-slate-900/60 shadow-2xl backdrop-blur-sm">
          {authError && (
              ...
              <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-between">
                {step > 1 ? (
                  <button
                    type="button"
                    onClick={prevStep}
                    className="flex items-center justify-center gap-2 rounded-lg border border-slate-700 bg-slate-800 px-6 py-3 font-medium text-slate-300 transition hover:border-slate-600 hover:text-white disabled:opacity-50"
                  >
                ...
                {step < 3 ? (
                  <button
                    type="button"
                    onClick={nextStep}
                    className="flex items-center justify-center gap-2 rounded-lg bg-amber-700 px-8 py-3 font-semibold text-white shadow-md shadow-amber-900/30 transition hover:bg-amber-600"
                  >
                    Continue
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="flex items-center justify-center gap-2 rounded-lg bg-amber-700 px-8 py-3 font-semibold text-white shadow-md shadow-amber-900/30 transition hover:bg-amber-600 disabled:opacity-60 disabled:hover:bg-amber-700"
                  >
                    {isLoading ? (
                      <>
                        <svg
