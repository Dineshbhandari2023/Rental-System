...
//           <h4 className="font-medium text-gray-900 mb-2">Role Benefits</h4>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          />
          {errors.firstName && (
            <p className="mt-2 text-sm font-serif text-red-800">{errors.firstName}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.lastName && (
            <p className="mt-2 text-sm font-serif text-red-800">{errors.lastName}</p>
          )}
        </div>
      </div>
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          {errors.role && (
            <p className="mt-2 text-sm font-serif text-red-800">{errors.role}</p>
          )}
        </div>

        <div className="bg-amber-100 border-2 border-amber-800 p-4">
          <h4 className="font-serif font-bold text-amber-950 mb-3">Role Benefits</h4>
      ...
      <div>
        ...
        {errors.password && (
          <p className="mt-2 text-sm font-serif text-red-800">{errors.password}</p>
        )}
        <p className="mt-2 text-sm font-serif italic text-amber-800">
          Must be at least 6 characters with uppercase, lowercase, and number
        </p>
      ...
      <div>
        ...
        {errors.confirmPassword && (
          <p className="mt-2 text-sm font-serif text-red-800">{errors.confirmPassword}</p>
        )}
      </div>
      ...
      <div className="flex items-center">
        <input
          ...
          className="h-5 w-5 border-2 border-amber-800 text-amber-800 focus:ring-amber-800"
        />
        <label htmlFor="terms" className="ml-3 block text-sm font-serif text-amber-900">
          I agree to the{" "}
          <Link
            to="/terms"
