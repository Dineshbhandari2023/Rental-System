...
const Register = () => {
  ...
  const InputField = ({
    ...
    <div>
      ...
      {error && (
        <p className="mt-2 text-sm font-serif text-red-400 flex items-center gap-1">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {errors["address.state"] && (
            <p className="mt-2 text-sm font-serif text-red-400">
              {errors["address.state"]}
            </p>
          )}
        </div>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gradient-to-br from-amber-900/20 to-amber-800/10 border-2 border-amber-800/30 p-6 h-fit rounded-md">
