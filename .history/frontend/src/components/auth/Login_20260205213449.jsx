          ...
          <div className="relative p-8 md:p-10">
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-slate-900/70 text-slate-400 font-serif">
                  Or continue with
                </span>
              </div>
            </div>

            {/* Social buttons – vintage dark style */}
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center gap-3 py-3 px-4 border border-slate-700/80 bg-slate-800/50 hover:bg-slate-700/60 text-slate-200 font-serif rounded-lg transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
