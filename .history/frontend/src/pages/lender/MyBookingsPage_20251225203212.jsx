...
export default function MyBookingsPage() {
  ...
  const loadLenderBookings = async () => {
    try {
      setLoading(true);
      // Fetch all non-pending bookings for the lender
      // We'll use a new service method or filter client-side if needed
      const response = (await bookingService.getLenderBookings?.()) || [];

      // Temporary fallback until backend endpoint exists
      // Replace with proper getLenderBookings when implemented
